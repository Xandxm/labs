...
struct EnergyDrink {
    ...
    bool sugarFree;         // Содержание сахара
};
...
void initializeCatalog() {
    ...
    EnergyDrink drinks[] = {
        ...
        {3, "Burn", "Яблоко", 500, 95.00, 90, false},
        {4, "Burn", "Манго", 500, 95.00, 90, false},
        {5, "Adrenaline Rush", "Оригинал", 500, 85.50, 100, false},
        {6, "Adrenaline Rush", "Лимон", 500, 85.50, 100, true},
        {7, "Monster", "Зеленая энергия", 500, 150.00, 160, false},
        {8, "Monster", "Ультра", 500, 155.00, 140, true},
        {9, "Gorilla", "Фруктовый микс", 500, 80.00, 75, false},
        {10, "Gorilla", "Кола", 500, 80.00, 75, false},
        {11, "Flash", "Цитрус", 500, 70.00, 85, false},
        {12, "Flash", "Экзотик", 500, 70.00, 85, true}
    };
